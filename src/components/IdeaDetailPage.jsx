  ...
  return (
    <div className="w-full py-6 space-y-8 text-[var(--foreground)] transition-colors">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        {/* Left Column (8 cols): Problem, Solution, Details, Tags, Discussion */}
        <div className="lg:col-span-8 space-y-8">
          ...
          {problemStatement && (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-6 sm:p-7 rounded-2xl border border-red-500/30 bg-red-500/5 dark:bg-red-500/10 shadow-sm space-y-3"
            >
          ...
          {proposedSolution && (
            <motion.div
              ...
              whileInView={{ opacity: 1, y: 0 }}
              viewport={{ once: true }}
              className="p-6 sm:p-7 rounded-2xl border border-cyan-500/30 bg-cyan-500/5 dark:bg-cyan-500/10 shadow-sm space-y-3"
            >
          ...
          <div className="p-6 sm:p-8 rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-sm space-y-4">
            ...
            <div className="text-sm sm:text-base leading-relaxed space-y-4 text-[var(--foreground)]">
              {detailedDescription ? (
                ...
                <p>
                  This idea envisions an innovative approach to modern startup solutions. By bridging current market gaps with efficient technological integration, it offers a scalable roadmap tailored for sustainable growth and user value creation.
                </p>
              )}
            </div>
          </div>
            ...
            <div className="p-6 rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-sm space-y-3">
              ...
              <div className="flex flex-wrap gap-2 pt-1">
                {tagList.map((tag, idx) => (
                  <span
                    key={idx}
                    className="px-3.5 py-1.5 rounded-xl border border-cyan-500/30 bg-cyan-500/10 text-xs font-bold text-cyan-600 dark:text-cyan-400 hover:border-cyan-500/60 transition-colors"
                  >
                    #{tag}
                  </span>
                ))}
          ...
          <div className="p-6 sm:p-8 rounded-2xl border border-[var(--border)] bg-[var(--card)] shadow-sm space-y-6">
            ...
            <form onSubmit={handleAddComment} className="space-y-3">
              ...
              <div className="flex justify-end">
                <button
                  type="submit"
                  className="inline-flex items-center gap-2 px-5 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-indigo-500 text-white font-bold text-sm shadow-md hover:shadow-cyan-500/20 hover:opacity-95 transition-all cursor-pointer"
                >
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <p className="text-[10px] text-[var(--secondary)]">{c.time}</p>
                      </div>
                    </div>
                  </div>
        ...
        <div className="lg:col-span-4 space-y-6">
          ...
          <div className="p-6 rounded-2xl border border-[var(--border)] bg-gradient-to-b from-[var(--card)] to-[var(--background)] shadow-lg space-y-5">
            ...
            <div className="space-y-3">
              <button
                className="w-full py-3 rounded-xl bg-gradient-to-r from-cyan-500 via-teal-400 to-cyan-500 text-white font-bold text-sm shadow-lg shadow-cyan-500/20 hover:opacity-95 transition-all cursor-pointer flex items-center justify-center gap-2"
              >
              ...
              <button
                className="w-full py-2.5 rounded-xl border border-[var(--border)] bg-[var(--card)] hover:bg-cyan-500/10 font-bold text-sm text-[var(--foreground)] transition-all cursor-pointer flex items-center justify-center gap-2 shadow-xs"
              >
